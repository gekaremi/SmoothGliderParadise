...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct 13 18:01:16 2018

@author: gekaremi(not really /;_;)
...
win.setWindowTitle('Interactive SmoothLife on pyqtgraph')
view = win.addViewBox()
...
view.setRange(QtCore.QRectF(0, 0, h, w))
